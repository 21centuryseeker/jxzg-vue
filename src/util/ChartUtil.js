...
class ChartUtil {
  ...
  drawChartShow (continerId, titleName, legendData, legendOrient, series, xdata, hasDATAZOME, options, targetEl, util, cb) {
    // progess legend
    // console.log(legendData, legendOrient)
    let fixLegendVData = this.progessLegend(legendData, legendOrient)
    // progess seriza
  ...
  goDraw (continerId, option, targetEl, cb) {
    if (option.color && Object.prototype.toString.call(option.color) === '[object String]') { /* cjs添加 */
