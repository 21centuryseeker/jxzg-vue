<template>
  <div style="margin-bottom: 20px;">
    ...
    <div v-if="flag - 0 === 1">
      ...
      <div class="targetBox" style="overflow: hidden;box-shadow: 0 2px 12px 0 rgba(0,0,0,.1);margin-top: 10px;">
        <div class="chart_show chart_szjg  chart_box_cjs" id="chart_box_randarChart" style="margin-top: 0px;width: 50%;float: left;">
          <img src="../../../assets/empty.jpg" alt="">
        </div>
        <div class="chart_show chart_jzgzcjbzc  chart_box_cjs" style="margin-top: 0px;width: 50%;float: left;box-shadow: none;">
          <div class="table_box_content" style="height: 390px;padding-top: 37px;">
            <table class="special_table">
              <thead>
                <tr>
                  <td>序号</td>
                  <td style="text-align: left;padding-left: 50px;">指标名称</td>
                  <td>得分</td>
                </tr>
              </thead>
              <tbody>
                <tr v-for="(item, index) in tableData" :key="index">
                  ...
                  <td style="text-align: left;padding-left: 50px;">{{item.name}}</td>
                  <td>{{item.score}}</td>
                </tr>
              </tbody>
            </table>
      ...
      <div class="targetBox" style="margin-top: 10px;">
        <el-card class="box-card">
          <div id="chart_box_randarChart" class="chartBox chart_box_cjs " style="height: 380px;">
            <div class="targetBox">
              ...
              <div class="table_box_content">
                <table class="special_table">
                  <thead>
                    <tr>
                      <td width="100">排名</td>
                      <td style="text-align: left;padding-left: 50px;">专业</td>
                      <td>学年</td>
                      <td>得分</td>
                    </tr>
                  </thead>
                  <tbody>
                    <tr v-for="(item, index) in tableData" :key="index">
                      <td width="100">{{pageSize * (currentPage - 1) + index + 1}}</td>
