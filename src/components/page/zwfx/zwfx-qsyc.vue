    ...
    <div class="jsc_content">
      <el-row :gutter="20">
        <template v-for="(item, index) in chartDates">
          <el-col :span="24" :key="index" style="margin-top: 20px;">
...
export default {
  ...
  methods: {
    ...
    getZbList () {
      // 获取指标
      // this.$ajax('post', this.HOST + '/tr/autognosis/web/getindexs', {
      //   indexType: this.user,
      //   roleId: this.job.split(',')[1],
      //   likeName: this.input,
      ...
      //     let arr = []
      //     for (let item of res.obj.data) {
      //       if (arr.length < 2) {
      //         arr.push(item)
      //       } else {
      //         this.zbItems.push(arr)
      //         arr = [item]
      //       }
      //     }
      //     this.zbItemsOld = res.obj.data
      //     this.zbItems.push(arr)
      //   } else {
      //     this.$message({
      //       type: 'error',
    ...
    addSure: function () {
      ...
      //     return
      //   }
      //   startTime = this.mydateFormat.dateCodeYmd(this.value6[0])
      //   endTime = this.mydateFormat.dateCodeYmd(this.value6[1])
      // } else if (timeType == 2) {
      //   let month
      //   if (this.radio2 - 0 === 2) {
      //     month = 2
      ...
      //   }
      //   let datestr = new Date(new Date().getFullYear() + '-' + (new Date().getMonth() + 1)).getTime() - 28 * 24 * 60 * 60 * 1000 * month
      //   startTime = new Date(datestr).getFullYear() + '-' + ((new Date(datestr).getMonth() + 1) < 10 ? ('0' + (new Date(datestr).getMonth() + 1)) : (new Date(datestr).getMonth() + 1))
      ...
      //     year = 4
      //   }
      //   startTime = new Date().getFullYear() - year
