...
<div class="mainContent">
      ...
      <div class="headerTitle paddingTop46">诊改知识库</div>
       ...
       <el-table @sort-change="sortList"  size="mini"  ref="multipleTable" :data="items"
          ...
          <el-table-column  class="contentTable" label="名称" align="left" >
              <template slot-scope="scope">
                 ...
                 <a class="linkText"  v-else href="javascript:void(0)" :title="scope.row.name"   @click="$router.push({path: '/preview/'+scope.row.id})">
                    <i class="iconfont DocClass" v-if="scope.row.textType=='docx'">&#xe618;</i>
         ...
         <el-table-column label="操作" align="center" width="80" >
              <template slot-scope="scope">
               ...
               <a  class="downLink"   v-if="typeValue!=4"  :href="host + scope.row.upUrl"  :download="scope.row.fullName"><i class="iconfont">&#xe63a;</i></a>

               <!-- <div class="downLink" v-if="(item.textType=='docx')&&typeValue!=4"> -->
                   <!-- <a :href="host + item.upUrl"  :download="item.fullName"><i class="iconfont">&#xe63a;</i></a> -->
                 <!-- </div> -->
