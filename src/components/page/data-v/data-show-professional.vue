  ...
  <div class="wrapper">
    ...
    <div class="mianWrapper clearfix">
      ...
      <div class="leftPart floatL">
        <div class="item itemspec" :class="{'item1':isShow ==2}">
...
export default {
  ...
  methods: {
    ...
    processProfessional: function (val) {
      this.baseAjax(26, '2017各专业部毕业生情况11').then((res) => { this.graphByLine(res, 'chart_zsqk', 'title1') })
      this.baseAjax(30, '在校人数').then((res) => {
      ...
      this.baseAjax(32, '在校人数').then((res) => {
        this.$set(this.titleMap, 'title5', res.data.title)
        let series = []
        for (let key in res.data.series) {
          series.push({
            type: 'bar',
      ...
      this.baseAjax(31, '2017各专业部毕业生情况11').then((res) => { this.graphByLine(res, 'chart_bysjy1', 'title6') })
      this.baseAjax(25, '学生人数').then(this.graphByProfessional)
      this.graphByProfessionalZB()
    },

    graphByProfessional: (res) => {
    ...
    graphByProfessionalZB: function () {
      this.$ajaxMore(
        'post',
