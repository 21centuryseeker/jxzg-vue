...
<div class="data-show">
  <div class="wrapper">
    ...
    <div class="mianWrapper clearfix">
      ...
      <!--中间部分-->
      <div class="MiddlePart  floatL" v-if="isShow !== 6">
...
export default {
  data () {
    return {
      ...
      zybList: [],
      value_tzjk: 0,
      baseUrl: this.HOST + '/tr/trCockpit/web/getChartDataById'
    }
  },
  watch: {
    isShow (val) {
  ...
  methods: {
    processDrivew: function (val) {
      this.baseAjax(1, '2017各专业部毕业生情况11').then((res) => { this.graphByLine(res, 'chart_zsqk', 'title1') })
      this.baseAjax(2, '众人众').then((res) => { this.graphByLine1(res, 'chart_bysjy', 'title5') })
    },

    graphByLine1: function (res, el, titleKey) {
      this.$set(this.titleMap, titleKey, res.obj.title)
      let series = [
        {
          name: '学生人数',
          type: 'bar',
      ...
      this.$ChartUtil.drawChartShow(el, '', {}, '', series, res.obj.dataxList, false, {
    ...
    graphByLine: function (res, el, titleKey) {
      ...
      this.$ChartUtil.drawChartShow(el, '', res.obj.legend, '', series, res.obj.dataxList, false, {

      }, this, '人')
    },

    process: function (val) {
      this.processDrivew(val)
      this.bigTitle = '课程总数'
      this.title1 = '公共素质课'
      this.title2 = '专业课'
      // this.switch(val)
    ...
    baseAjax: function (id, consoleflag) {
      let promise = new Promise((resolve, reject) => {
        this.$ajaxGet(this.baseUrl, {chartId: id}, (data) => {
