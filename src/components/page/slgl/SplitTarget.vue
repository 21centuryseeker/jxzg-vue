<template>
    <div class="scroll_x_hidden_box">
        <!-- <div class="container_box_header">分解目标</div> -->
        <!-- 基本信息 -->
        <div class="bg_box">
            ...
            <div class="shfs_box box_list" style="padding-bottom: 20px;">
                ...
                <div class="item_box">
                    ...
                    <div v-if="shType == 3">
                        ...
                        :remote-method="checkUserChange" remote
                        filterable placeholder="请选择" style="margin: 0 50px;">
  ...
  mounted () {
    ...
    self.$ajax(
      ...
      (res) => {
        // return
        if (res.success) {
          self.fatherTarget = res.obj.targetName
          self.deptId = res.obj.deptId
          // 获取工作标准
  ...
  methods: {
    ...
    doSubmit () {
      ...
      if (self.zb_id) {
        ...
        let data = {
          parentId: self.$router.currentRoute.params.id,
          deptId: self.deptId,
