    ...
    <div class="bg_box">
      <div class="jb_news_box box_list">
        ...
        <div class="item_box">
          ...
          <div class="item_right">
            <el-input placeholder="请输入计划名称" style="width: 800px;" v-model="planName">
            </el-input>
          </div>
        </div>
        <!-- 目标描述 -->
        <div class="item_box">
          ...
          <div class="item_right">
            <el-input placeholder="请输入计划描述" type="textarea" :rows="2" style="width: 800px;" v-model="targetInfo">
            </el-input>
          </div>
        </div>
        <!-- 权重 -->
...
export default {
  ...
  mounted() {
    this.$ajax(
      ...
      res => {
        if (res.success) {
          this.fatherTarget = res.obj.id;
          this.fatherTargetName = res.obj.target_name;
