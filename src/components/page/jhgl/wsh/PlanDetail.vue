        ...
        <el-col :span="14">
          ...
          <div class="grid-content bg-purple">
            <div class="detail_item_box">
              <div class="detail_item_left">
                <i class="iconfont detail_icon">&#xe636;</i>
                所属目标</div>
              <div class="detail_item_right">{{targetName || '无'}}</div>
            </div>
          </div>
          <div class="grid-content bg-purple">
            <div class="detail_item_box">
          ...
          <div class="grid-content bg-purple">
            ...
            <div class="grid-content bg-purple">
              <div class="detail_item_box">
                ...
                <div class="detail_item_right">
                  <!--{{cyName}}-->
                  <el-tag style="margin-right: 10px" v-for="(val,key) of cyNames" :key="key+1">{{val}}</el-tag>
                </div>
              </div>
            </div>
          <div class="grid-content bg-purple">
          ...
          <div class="grid-content bg-purple" style="background: #fff6f6;border: 1px solid #ffdada;" v-if="listWarn.length">
            <div class="detail_item_box yj_box">
              ...
              <div class="detail_item_right" style="line-height: 40px;padding: 10px 0 10px 20px;">
          ...
          <div class="grid-content bg-purple" v-if="listFile.length">
            <div class="detail_item_box">
              <div class="detail_item_left">
                ...
                附件</div>
              <div class="detail_item_right" >
                <template v-if="!listFile || !listFile.length">无</template>
      ...
      self.$ajaxMore('post', self.HOST + '/tr/planAudit/web/auditPlan', data, (res) => {
        if (res.success) {
          ...
          if (this.daList && this.ifShowDa) {
            this.$ajaxMore('post', this.HOST + '/tr/trdak/web/fileGd', {data: this.daList}, (res) => {
              if (res.success) {
                self.$message({
                  message: res.msg,
                  type: 'success'
