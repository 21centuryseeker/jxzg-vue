<template>
  <div>
    <!-- <div class="container_box_header">我审核的目标</div> -->
    <!-- 操作容器 -->
    <div class="bg_box">
    <div class="operation_box boxShadow">
      ...
      <div class="operation_item">
        ...
        <div class="operation_item_right">
          <el-select v-model="shqkInput" placeholder="审核情况" style="width: 98px;" size="small">
            <el-option
      ...
      <div class="operation_item">
        <!-- <div class="operation_item_left">所属部门</div> -->
        <div class="operation_item_right">
          <el-select v-model="targetDept" placeholder="所属部门" style="width: 98px;" size="small">
            <el-option
              label="所属部门"
              value=""
            ></el-option>
      ...
      <div class="operation_item" style="margin-left: 20px;">
        ...
        <div class="operation_item_right">
          <el-select v-model="targetState" placeholder="完成情况" size="small" style="width: 98px;">
            <el-option
      ...
      <div class="operation_item" style="margin-left: 20px;">
        ...
        <div class="operation_item_right">
          <el-input v-model="targetName" placeholder="请输入目标名称" size="small" style="width: 152px;"></el-input>
        </div>
      </div>
      <!-- 搜索按钮 -->
      <el-button type="info"  size="small" style="height: 32px;" @click="searchFunc">搜索</el-button>
    </div>
    <!-- 视图容器 -->
    ...
    <el-table-column
      label="目标">
      <template slot-scope="scope">
        <a href="javascript:void(0)" @click="toDetail(scope.row.id)">{{scope.row.target_name}}</a>
  ...
  methods: {
    ...
    deleteFunc () {
      if (this.multipleSelection.length === 0) {
        ...
        let self = this
        self.$ajax('post', self.HOST + '/tr/trTarget/web/delTargetById', {targetId: self.multipleSelection[0].id}, (res) => {
          if (res.success) {
            self.$message({
              message: res.msg,
              type: 'success'
    ...
    router_to_edit () {
      if (this.multipleSelection.length === 0) {
        ...
        this.$router.push({path: '/editTarget/' + this.multipleSelection[0].id})
      }
    }
  }
}
