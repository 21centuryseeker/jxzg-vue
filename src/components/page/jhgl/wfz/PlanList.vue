<template>
  <div class="cell_pointer">
    ...
    <div class="bg_box">
      ...
      <div class="operation_item" style="margin-left: 6px;" v-if="planType - 0 === 3" key="select1">
        ...
        <div class="operation_item">
          ...
          <div class="operation_item_right">
            <el-date-picker style="width: 248px;" v-model="targetTime" type="daterange" size="small" :editable="false" range-separator="至" start-placeholder="开始日期" 
      ...
      <div class="table_page_box boxShadow" key="table1" v-if="planType1 - 0 === 2">
        <el-table size="mini" ref="multipleTable" :data="tableData" @selection-change="handleSelectionChange"
        @sort-change="sortChange"
         ...
         >
          ...
          <el-table-column prop="dept_name" label="所属部门" align="left" show-overflow-tooltip  :width="$store.state.$screenWidth">
          </el-table-column>
    ...
    <el-table-column
      ...
      label="所属部门"
      show-overflow-tooltip
      align="left"  :width="$store.state.$screenWidth">
    </el-table-column>
    <el-table-column
      label="负责人"
      width="120"
...
export default {
  ...
  methods: {
    ...
    deleteFunc (id) {
      let self = this
      this.$ajax('post', this.HOST + '/tr/trPlan/web/checkUser', {id: id}, (res1) => {
        if (res1.success) {
          this.$confirm(
            ...
            self.$ajax(
              'post',
              self.HOST + '/tr/trPlan/web/delBatchPlan',
              { planIds: id },
              (res) => {
                if (res.success) {
                  self.$message({
